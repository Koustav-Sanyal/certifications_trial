...
def rt2020(request, cert_id):
    if(cert_id == "123456" or cert_id == "789456" or cert_id == "512456"):
        img_path = os.path.join(BASE_DIR, "rt/data/rt2020/" + cert_id + ".png")
    ...
    try:
        file_path = os.path.join(BASE_DIR, 'rt/data/rt2020/rt2020.csv')
        image_path = os.path.join(BASE_DIR, 'rt/data/rt2020/rt2020.png')
        save_path = os.path.join(BASE_DIR, 'rt/data/rt2020/rt2020_all/')
